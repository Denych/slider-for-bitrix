...
$arParams["SLIDER_WIDTH"] = $arParams["SLIDER_WIDTH"];
$arParams["SLIDER_HEIGHT"] = $arParams["SLIDER_HEIGHT"];
...
if(isset($arResult["ID"]))
{
	...
	if ($arParams["SLIDER_WIDTH"] && $arParams["SLIDER_HEIGHT"])
	{
		$arResult["SLIDER_WIDHT"] = $arParams["SLIDER_WIDTH"];
		$arResult["SLIDER_HEIGHT"] = $arParams["SLIDER_HEIGHT"];
	} else {
		$arResult["SLIDER_WIDTH"] = "500";
		$arResult["SLIDER_HEIGHT"] = "150";
	}
